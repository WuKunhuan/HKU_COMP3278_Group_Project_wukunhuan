...
myconn = mysql.connector.connect(host="localhost", user="root_0", passwd="123456", database="facerecognition")
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if conf >= 60:
            ...
            name = database.cursor.execute(select)
            ...
            # If the student's information is found in the database
                ...
                database.cursor.execute(update, val)
